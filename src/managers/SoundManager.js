...
import { StartMenuSong } from '../audio/songs/StartMenuSong.js';
...
class SoundManager {
    constructor() {
        ...
        // Songs (modular Tone.js compositions)
        this.startMenuSong = null;  // Will be StartMenuSong instance
    ...
    async playStartMenuSong() {
        ...
        // Create song instance if needed
        if (!this.startMenuSong) {
            this.startMenuSong = new StartMenuSong();
        }
        
        // Play the song (handles its own looping)
        await this.startMenuSong.play();
    }
     ...
     */
    stopStartMenuSong() {
        if (this.startMenuSong && this.startMenuSong.isPlaying) {
            this.startMenuSong.stop();
        }
    }
