(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var getEventName = function (event, id) {
        return "".concat(event).concat(id).replace(/[^a-zA-Z0-9]/g, '');
    };
    var BASE36 = 36;
    var idGenerator = function () {
        var now = performance.now().toString(BASE36);
        var random = Math.random().toString(BASE36).substring(2);
        return "".concat(now).concat(random).replace(/[^a-zA-Z0-9]/g, '');
    };
    /**
    ...
    var VirtualJoystick = /** @class */ (function (_super) {
        ...
        function VirtualJoystick(_a) {
            var scene = _a.scene, deadZone = _a.deadZone, baseArea = _a.baseArea, stick = _a.stick, stickIcon = _a.stickIcon, bounds = _a.bounds, _b = _a.enableWithoutTouch, enableWithoutTouch = _b === void 0 ? false : _b, id = _a.id;
            ...
            _this.id = id !== null && id !== void 0 ? id : idGenerator();
        ...
        VirtualJoystick.prototype.on = function (event, callback) {
            if (event === 'move') {
                var eventName = getEventName(exports.VirtualJoystickEvents.UPDATE, this.id);
                this.scene.events.on(eventName, callback);
                return this;
            }
            if (event === 'release') {
                var eventName = getEventName(exports.VirtualJoystickEvents.RELEASE, this.id);
                this.scene.events.on(eventName, callback);
                return this;
            }
            if (event === 'press') {
                var eventName = getEventName(exports.VirtualJoystickEvents.PRESS, this.id);
                this.scene.events.on(eventName, callback);
                return this;
            }
        ...
        VirtualJoystick.prototype.emitMove = function (x, y) {
            var eventName = getEventName(exports.VirtualJoystickEvents.UPDATE, this.id);
            this.scene.events.emit(eventName, { x: x, y: y });
        };
        /**
